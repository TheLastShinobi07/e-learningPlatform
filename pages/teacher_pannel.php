...
if(isset($_SESSION['pub_id'])){
    if(isset($_POST['submit'])){
        ...
        if($ext == "pdf"){
            ...
            $sql = "INSERT INTO `courses`(`course_file`, `thumbnail`, `course_name`, `course_category`, `course_desc`, `pub_id`) VALUES ('$file_name', '$thumbnail_name','$course_name','$category','$description','$pub_id')";
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><a href="coursedelete.php?id=<?php echo $row['id']; ?>">Delete</a></td>
                </tr>
                <?php
                        }
                    }
